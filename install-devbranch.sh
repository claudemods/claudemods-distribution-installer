...
cd /opt/claudemods-distribution-installer && sudo g++ -o mainscript mainscriptdev.cpp -std=c++23
cd /opt/claudemods-distribution-installer && sudo g++ -o updater updaterdev.cpp -std=c++23
