...
echo -e "${CYAN}"
echo "           ClaudeMods Vanilla Arch Kde Grub to Apex CKGE Minimal v1.0 27-10-2025"
echo -e "${NC}"
echo "================================================================================"
echo ""
...
cp -r /opt/claudemods-distribution-installer/apex-ckge-minimal/aurorae /home/$USER/.local/share
