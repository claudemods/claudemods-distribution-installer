...
private:
    ...
    void install_cachyos_kde(const std::string& drive) {
        ...
        execute_command("chroot /mnt /bin/bash -c chown " + new_username + " /mnt/home/" + new_username + "/.config");
        execute_command("chroot /mnt /bin/bash -c chown " + new_username + " /mnt/home/" + new_username + "/.config/autostart");
