...
private:
    ...
    void install_spitfire_ckge(const std::string& drive) {
        ...
        execute_command("mv /mnt/home/" + new_username + "/cachyos /mnt/home/" + new_username);
        ...
        execute_cd_command("chmod +X /mnt/home/$USER/.config/fish/config.fish");
        execute_cd_command("chmod +X /mnt/usr/share/fish/config.fish");
