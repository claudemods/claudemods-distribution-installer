...
sudo -S cp -r /opt/claudemods-distribution-installer/spitfire-ckge-minimal/grub /etc/default
print_status "GRUB configuration copied"

print_info "Generating new GRUB configuration..."
sudo -S cp -r /opt/claudemods-distribution-installer/spitfire-ckge-minimal/10_linux /etc/grub.d
sudo -S cp -r /opt/claudemods-distribution-installer/spitfire-ckge-minimal/grub.cfg /boot/grub
sudo -S cp -r /opt/claudemods-distribution-installer/spitfire-ckge-minimal/cachyos /usr/share/grub/themes
...
sudo -S cp -r /opt/claudemods-distribution-installer/spitfire-ckge-minimal/term.sh /usr/local/bin
sudo -S chmod +x /usr/local/bin/term.sh
sudo -S cp -r /opt/claudemods-distribution-installer/spitfire-ckge-minimal/term.service /etc/systemd/system/
...
cd /opt/claudemods-distribution-installer/spitfire-ckge-minimal && sudo -S unzip SpitFireLogin.zip -d /usr/share/sddm/themes
sudo -S cp -r /opt/claudemods-distribution-installer/spitfire-ckge-minimal/kde_settings.conf /etc/sddm.conf.d
...
sudo -S chmod +x /opt/claudemods-distribution-installer/spitfire-ckge-minimal/installspitfiretheme.sh
sudo -S chmod +x /opt/claudemods-distribution-installer/spitfire-ckge-minimal/start.sh
