...
cp -r /home/$TARGET_USER/claudemods-distribution-installer/installer/spitfire-ckge-minimal/wallpaperdev.desktop /home/$TARGET_USER/.config/autostart
sudo -S chmod +x /home/$TARGET_USER/.config/autostart/wallpaperdev.desktop
sudo -S chown $TARGET_USER /home/$TARGET_USER/.config/autostart/wallpaperdev.desktop
...
sudo -S chmod +x /home/$TARGET_USER/claudemods-distribution-installer/installer/spitfire-ckge-minimal/installspitfirethemedev.sh
cd /home/$TARGET_USER/claudemods-distribution-installer/installer/spitfire-ckge-minimal && ./installspitfirethemedev.sh $TARGET_USER
